...
insert into content (courseID, section, title, description, slideURL, labURL) values ('monitoring-logging', 'pcf-general', 'Moniting and Logging', '', 'monitoring-logging.pdf', 'monitoring-logging/index.html');
...
insert into content (courseID, section, title, description, slideURL, labURL) values ('a-new-way-of-working-dell', 'dellemc', 'A New Way of Working', '', 'a-new-way-of-working-dell.pdf', '');
...
insert into content (courseID, section, title, description, slideURL, labURL) values ('blue-green-deployments', 'pcf-developer-previous', 'Blue-Green Deployments', '', 'resources/presentations/blue-green.pdf', 'blue-green/index.html');
